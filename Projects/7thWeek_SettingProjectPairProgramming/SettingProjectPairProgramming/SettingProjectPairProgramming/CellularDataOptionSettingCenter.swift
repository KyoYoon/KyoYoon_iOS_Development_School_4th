//
//  CellularDataOptionSettingCenter.swift
...
enum CellularDataOptionCellStyle:String {
...
class CellularDataOptionSettingCenter {
    
    
    static let sharedInstance = CellularDataOptionSettingCenter()
    ...
    func cellStyleForRow(indexPathAt: IndexPath) -> CellularDataOptionCellStyle {
        ...
        return CellularDataOptionCellStyle.init(rawValue: style)!
    }
    
    
    func loadDataFromSettingPlist() {
        if let path = Bundle.main.path(forResource: "CellularDataOptionSetting", ofType: "plist"),
