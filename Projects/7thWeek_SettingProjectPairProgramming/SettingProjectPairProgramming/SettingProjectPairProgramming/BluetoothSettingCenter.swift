...
enum BluetoothCellStyle:String {
...
class BluetoothSettingCenter {
    
    
    static let sharedInstance = BluetoothSettingCenter()
    ...
    func cellStyleForRow(indexPathAt: IndexPath) -> BluetoothCellStyle {
        ...
        return BluetoothCellStyle.init(rawValue: style)!
    }
    
    
    func loadDataFromSettingPlist() {
        if let path = Bundle.main.path(forResource: "BluetoothSetting", ofType: "plist"),
