...
class CarrierSettingCenter {
    
    
    static let sharedInstance = CarrierSettingCenter()
    ...
    func cellStyleForRow(indexPathAt: IndexPath) -> CarrierCellStyle {
        ...
        return CarrierCellStyle.init(rawValue: style)!
    }
    
    
    func loadDataFromSettingPlist() {
        if let path = Bundle.main.path(forResource: "CarrierSetting", ofType: "plist"),
