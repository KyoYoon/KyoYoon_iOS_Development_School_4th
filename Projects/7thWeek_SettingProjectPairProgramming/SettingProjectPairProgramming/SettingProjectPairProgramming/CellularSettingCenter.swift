...
class CellularSettingCenter {
    
    
    static let sharedInstance = CellularSettingCenter()
    ...
    func cellStyleForRow(indexPathAt: IndexPath) -> CellularCellStyle {
        ...
        return CellularCellStyle.init(rawValue: style)!
    }
    
    
    func loadDataFromSettingPlist() {
        if let path = Bundle.main.path(forResource: "CellularSetting", ofType: "plist"),
