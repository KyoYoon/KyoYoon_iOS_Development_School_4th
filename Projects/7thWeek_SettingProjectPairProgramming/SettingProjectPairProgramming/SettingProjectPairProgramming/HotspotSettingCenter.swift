...
class HotspotSettingCenter {
    
    
    static let sharedInstance = HotspotSettingCenter()
    ...
    func cellStyleForRow(indexPathAt: IndexPath) -> HotspotCellStyle {
        ...
        return HotspotCellStyle.init(rawValue: style)!
    }
    
    
    func loadDataFromSettingPlist() {
        if let path = Bundle.main.path(forResource: "HotspotSetting", ofType: "plist"),
