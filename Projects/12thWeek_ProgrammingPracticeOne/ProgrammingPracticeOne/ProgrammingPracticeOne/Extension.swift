...
//fileprivate var btnAction2:(Void)->Void {}

extension UIButton
{
    func addTargetClosure(_ target: Any?, for controlEvents: UIControlEvents, action:@escaping (Void) -> Void)
    {
        //var btnAction2:(Void)->Void {}
        self.addTarget(target, action: #selector(btnHandler), for: controlEvents)
    }
